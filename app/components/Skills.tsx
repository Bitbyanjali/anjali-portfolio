...
function SkillCard({
  ...
  return (
    ...
    >
      <div
        className="w-12 h-12 mb-3 rounded-xl bg-[#242428] border border-border flex items-center justify-center transition-all group-hover:border-gold group-hover:bg-gold/10"
      ...
      <div className="w-full h-1 mt-3 rounded-full bg-[#242428] overflow-hidden">
        <motion.div
